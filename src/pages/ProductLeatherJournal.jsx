...
import printableImg from "../assets/Careox-Integrated-Printable-Page-Heal-Conscious-1536x1113.png";
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 pt-5 pb-2">
        <nav className="text-xs text-gray-400 flex flex-wrap gap-1 items-center">
          ...
          <span>/</span>
          <span className="text-gray-500">Vintage Leather Wellness Journal | 380 Pages</span>
        </nav>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          ...
          <div className="w-full lg:flex-1 flex flex-col">
            ...
            <h1 className="text-2xl sm:text-[1.75rem] font-semibold text-gray-900 leading-snug mb-3">
              Vintage Leather Wellness Journal | 380 Pages
            </h1>
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-3">
              The Heal Conscious, mental healthcare in a box integrated 380 pages vintage leather journal has features that help you keep a track of your program activity and even integrate the elements in your routine journaling / scheduling.
            </p>
          ...
          <div className="py-10 text-gray-600 leading-relaxed text-[15px]">
            {activeTab === "description" ? (
              <div className="space-y-5 max-w-3xl">
                <p>
                The Heal Conscious Careox integrated 380-Page Leather Mental Health Journal combines the elegance of a vintage leather notebook with ample space to support your longwinded ramblings and emotional outpour to unwind yourself for retrospective inspection.
                </p>

                <p>The journal is designed on psychological principles, and include features to help you improve your daily routine and cultivate better habits.</p>
        
                <div>
                  <h4 className="font-bold mb-4 text-gray-900 text-base">Key Features:</h4>
                  <ul className="space-y-3">
                    {[
                      ["Pages and Dimensions", ' With 6.5” width x 7.5” height x 2.5” depth and 380 pages. The journal offers enough space for a full year of reflections, mood tracking, and gratitude journaling.'],
                      ["Perfect Page Size", " A5 page size which is compact yet spacious, designed for comfortable writing and easy portability."],
                      ["Premium Vintage Leather Cover", "A timeless, handcrafted design that is durable, stylish, and built to last."],
                      ["Beautiful Gift for Self-Care", " Ideal for birthdays, holidays, or as a thoughtful gesture for loved ones seeking balance and mindfulness."],
                      ["Daily Growth Companion", " Encourages mindfulness, gratitude, habit-building, and deeper self-awareness every day."],
                    ].map(([title, desc]) => (
              ...
              <div className="max-w-2xl"><br />
                <p className="text-gray-800 mb-8">There are no reviews yet.</p>
                <h6>Be the first to review “Vintage Leather Wellness Journal | 380 Pages”</h6>
      ...
      <section className="w-full border-t border-gray-100 mt-2 py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          ...
          <div className="flex items-center gap-4 mb-10">
            ...
            <h2 className="text-sm font-bold tracking-widest uppercase text-gray-800 px-2">
              Related Products
            </h2>
            <div className="flex-1 border-t-2 border-dotted border-gray-300" />
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div className="group cursor-pointer">
              <div
                className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100 mb-3"
              ...
              <p className="text-sm text-gray-700 text-center mb-1">Careox Program Printable Calendar</p>
              <p className="text-sm font-semibold text-blue-600 text-center">$15.00</p>
            </div>
