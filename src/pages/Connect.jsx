      ...
      <div className="flex-1 py-10 px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-6 sm:p-8">
          ...
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 py-1 px-3">
           When you write about the stressful events in your life or the thoughts that keep you up at night, you’re essentially releasing them to the outside world. This can make you feel lighter and less burdened, ultimately reducing stress and anxiety. As a stress management tool, journaling works best when it is done consistently.</p>

<p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 py-1 px-3">
          Unlike other stress management techniques, like walking, gardening, or working out, journaling is a low-maintenance activity – making it perfect for people of all ages and fitness levels. All you need is a pen and paper (or a digital writing platform) and you’re set to work through the pain, traumas, and negativity and find relief. </p>
...
<p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 py-1 px-3">
     Through journal writing, you can identify patterns, triggers, and recurring themes, which can lead to a deeper understanding of how you respond to different situations and why you react the way you do. By reviewing your past journal entries, you can pinpoint your emotional triggers and become more aware of your own positive and negative behaviors. This increased self-awareness can help you make more informed, thoughtful decisions and become more confident with who you are as a person.</p>
       ...
       <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 py-1 px-3">
          ...
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 py-1 px-3">Suppressing or repressing emotions and avoiding traumatic memories are all coping mechanisms to protect oneself from the full impact of these painful events. Since journaling provides a safe space to express and release intense emotions associated with trauma, you can actually process what happened and how you feel about it. 
          </p>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 py-1 px-3">Many therapists often recommend journaling about traumatic experiences as a way to externalize the trauma – making it something that exists outside of you rather than something you carry internally. This creates a psychological distance between you and the traumatic experience, giving you a sense of control over it and reducing its power. </p>

        <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 py-1 px-3">Of course, healing works differently for everyone, but writing about your pain can help you make sense of it and eventually move forward. By reflecting on your past experiences, you can conduct your own retrospective inspection, beginning a journey of healing and trauma recovery.</p>


          <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3 mt-6 py-1 px-3">The Neuroscience Behind Journaling</h2>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 py-1 px-3">
          While journaling sounds like a simple act of putting pen to paper, it’s a scientifically backed practice that influences our brain in profound ways. </p>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 py-1 px-3">
          ...
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 py-1 px-3">
          The act of writing, especially when it involves introspection and reflection, also stimulates the prefrontal cortex – or the brain’s “command center.” This area of the brain is more involved in cognitive processing, problem-solving, and decision-making, all of which are enhanced through regular journaling. </p>
          ...
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">
           Many people hesitate to start journaling because they fear that they’re not a good writer or they don’t know what to write about. Some people are reluctant to relive their traumatic experiences while others complain that they don’t have the time to journal. While all of these concerns are valid, overcoming these resistances is the first step to start journaling. </p>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">
          Take a piece of paper and a pen. Ask yourself, “What’s holding you back from expressing how you really feel?”, “What are you afraid to feel?” </p>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">
          Write down the answer to these questions in your journal without overthinking or overcomplicating it. Don’t hold back. Write down exactly what comes to your mind. Get everything out of your system because only then you can go to the next step and begin healing. </p>
             ...
             <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">
         There is no right or wrong way to journal, but sometimes we just need a little push to get started. Here are some tips to help you start journaling:</p>

          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 mt-4 py-1 px-3">Choose Your Journal</h3>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">
           The first step in starting journal writing is to pick a notebook or digital platform that resonates with you and inspires you to write. Consider the size, style, and overall aesthetic of the journal. Choose something that motivates you to pick it up every day and write.</p>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">
           If notebooks are not your thing, explore digital journaling apps. Most of them have clean interfaces and come with customizable templates. Experiment with different options to find the perfect fit. You could even open up a blank doc on your laptop and start typing away.</p>

          
          
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 mt-4 py-1 px-3">Write Every Day</h3>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">Like all other habits, consistency is key when it comes to journaling. Writing every day can help you establish a consistent journaling routine. Set aside a specific time, even if it’s only 15 to 20 minutes daily, dedicated to journaling and write whatever comes to mind. </p>
        
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">
          Select a time of day that works best for you. This could be early morning before starting your day, evenings before you sleep, or any other period that fits your schedule. Even if you can’t dedicate 20 minutes, any amount of time is beneficial – just pick up the pen and start writing. Over time, this consistent practice will help you develop a deeper connection with your thoughts and feelings. </p>
          



          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 mt-4 py-1 px-3">Start Small</h3>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">Once you start getting into the habit of journaling, don’t feel pressured to fill pages with deep thoughts from the beginning. Start with short, simple entries about your day, your feelings, or anything that comes to mind. As you become more comfortable, you’ll naturally find yourself writing more extensively.</p>
          

          
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 mt-4 py-1 px-3">Write Freely</h3>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">Don’t overthink or hold yourself back when writing. Silence your inner critic —the voice that repeatedly wants you to correct your mistakes or censor yourself— and write freely. Be honest with yourself and pour out your raw emotions of anger, disgust, sadness, lust, fear, or anything that arises onto the pages. </p>
           <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">Remember, your journal is a safe space for raw, unfiltered, and uncensored thoughts and feelings. Feel free to explore the darkest corners of your mind without fear of judgment or criticism.</p>
          
  

  
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 mt-4 py-1 px-3">Use Journaling Prompts</h3>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">If you find yourself getting stuck or struggling to write anything, you can use journaling prompts. Journal prompts are essentially open-ended questions or statements that can jumpstart your writing. These prompts can help you overcome writer’s block by exploring certain emotions and topics. 

          </p>
           <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">Journaling prompts can be as simple as “What are you grateful for today?” or “How do you feel about yourself today, at this moment?” Some prompts can push you to focus on your personal challenges or face your fears. </p>
          ...
          <ul className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">
          ...
          <li>Describe your ideal self. What steps can you take to move closer to this vision?
          </li>
          <li>Who are some people who taught you about unconditional love when you were at your lowest point? </li>
          <li>What are some anger and frustrations you’re holding onto? 
          </li>
          <li>Describe a moment of peace and tranquility you experienced recently.</li>
            ...
            <li>Describe a person who has had a significant impact on your life. What qualities do you admire in them?</li>
              ...
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">All of us have been through different experiences which is why it’s important to find a journaling approach that suits your individual needs. There’s no one-size-fits-all approach and you can experiment with different styles and formats to find what works best. Here are some popular journaling styles:</p>


            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 mt-4 py-1 px-3">Stream Of Consciousness  </h3>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">Stream Of Consciousness (SOC) journaling is a technique that involves writing down whatever comes to mind without any filter or structure. It’s like capturing the raw, unedited content of your thoughts and letting them flow on the pages of your journal. Write down whatever comes to your mind, no matter how random or jumbled it may seem. </p>
               <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">Set a timer for 10 to 20 minutes, find a peaceful spot, and write your thoughts and feelings without editing or filtering them. Don’t pause to think or correct your mistakes and keep writing till the timer goes off. SOC journaling is a great way to clear your mind and get to know yourself better.</p>



                
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 mt-4 py-1 px-3">Gratitude Journaling </h3>
                  <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">Gratitude journaling is a simple yet powerful practice for improving your mental well-being. A gratitude journal is a space where you regularly record things you’re thankful for. This can be as simple as a good day with your friends or a comforting hug from your mom. </p>
                  <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">The key is to focus on the positives, the simple joys that otherwise get lost in the hustle and bustle of daily life. By intentionally focusing on the positive aspects of your life, you shift your attention away from negativity and cultivate a greater sense of appreciation.  </p>




            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 mt-4 py-1 px-3">Self-Reflection Journaling </h3>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">Self-reflection journaling is a practice of introspective writing that involves examining your thoughts, feelings, experiences, and behaviors. It allows you to process your day-to-day events, your reactions to them, and the emotions they elicit. </p>
               <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 py-1 px-3">Take time out every day, even if it’s five minutes, to sit and reflect on your day. This will help you gain a deeper understanding of your thoughts which can further help identify recurring patterns and triggers. It’s like having a conversation with yourself, where you explore your inner world and gain deeper self-awareness. </p>
    ...
    <div className="min-h-screen bg-[#eef0f5] flex flex-col">
      <div className="flex-1 py-10 px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-6 sm:p-8">
          ...
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">
          But when you have a lot on your plate, it’s easy to feel overwhelmed.</p>
           <p className="text-gray-800 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">
           The pressures we have take many forms</p>
          ...
          <p className="text-xs text-gray-400 mb-2 py-1 px-3">• Work pressures, long hours, deadlines to meet, new projects to manage</p>
           <p className="text-xs text-gray-400 mb-2 py-1 px-3">• Work/life balance, by the time you get home, you feel emotionally, mentally, and physically drained with no energy for the people you care about </p>
            <p className="text-xs text-gray-400 mb-2 py-1 px-3"></p>
             <p className="text-xs text-gray-400 mb-2 py-1 px-3">• Managing a house, a family, supporting everyone and meeting emotional expectations</p>
              <p className="text-xs text-gray-400 mb-2 py-1 px-3">• Studying, revising, pressure of exams, trying to find a job
The pressures we face vary, depending on who we are and what stage we are at, in the journey of life…</p>
    
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">
           But how do we ensure that we actually meet our objectives and do the things we need to do?
Here are a few suggestions that could help…</p>


              <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">
        The eye of the eagle:</p>
        ...
        <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">First take a ‘bird’s eye view’ at all the things going on in your life and list them, e.g.:</p>
                ...
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">
        Family, friends, partner, work, university etc.</p>

         <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">
        If it helps you could write them down, to get it out of your head and give you a visual focus.</p>
  ...
  <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">
       Then prioritize three things that you need to deal with or complete in the near future.</p>
...
<p className="text-xs text-gray-600 mb-2 py-1 px-3">•Sometimes it can be helpful to give yourself a deadline/date to complete your prioritised task.</p>
 ...
 <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">
        You can work through the rest of your top three using this method, then repeat the process again with the other areas of your life, you feel need attention.</p>


 <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">
        The importance of slowing down and taking small steps
When we think about all the things we need to do at once, it all just becomes a monstrous mass of pressure, stress, and tension but…</p>



 <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2 py-1 px-3">
        If we can slow down, breath and remember that the things we have in our lives are there because we chose them, we can then break them up and look at them one by one, step by step.</p>
    ...
    <div className="min-h-screen bg-[#eef0f5] flex flex-col">
      <div className="flex-1 py-10 px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-6 sm:p-8">
          ...
          <p className="text-gray-700 text-sm py-1 px-3">With love,Lena
          </p>
...
export default function ConnectPage() {
  ...
  if (showArticle2) {
    return <ArticlePage2 onBack={() => setShowArticle2(false)} />;
  }

  if (showArticle3) {
    return <ArticlePage3 onBack={() => setShowArticle3(false)} />;
  }
          ...
          <main className="flex-1 flex flex-col gap-6">
            ...
            <div className="rounded-2xl overflow-hidden shadow-md relative group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <button className="bg-[#3dbf9e] hover:bg-[#33a888] text-white font-bold text-sm px-6 py-2.5 rounded-full shadow-lg transition-all active:scale-95">Join us now, it's free!</button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-end">
                ...
                <button className="bg-[#4a6cf7] hover:bg-[#3b5de7] text-white font-bold py-3 rounded-xl transition-all shadow-lg">Login</button>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-x-2">
                      ...
                      <span className="text-yellow-500">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M12 1L9 5H4v5l-4 3 4 3v5h5l3 4 3-4h5v-5l4-3-4-3V5h-5l-3-4z" /></svg>
                      </span>
                ...
                <div className="p-4 px-6 flex items-center gap-3">
                  ...
                  <p className="text-gray-500 text-sm">
                    ...
                    <span className="text-blue-600 font-medium hover:underline cursor-pointer">Login</span>{" "}to react or comment on this post.
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                ...
                <div className="mx-4 mb-4 border border-gray-200 rounded-xl overflow-hidden">
                  <div className="p-4">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed">
                      Connect is your doorway into a collective healing experience. Plug in now!
                    </p>
                  </div>
                  <div className="border-t border-gray-100 px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-2">
